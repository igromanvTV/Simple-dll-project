...
typedef struct global_State
{
    ...
    LUAU_SHUFFLE5(LUAU_SEMICOLON_SEP,
        ...
        globalstate_ttname<TString*> ttname[LUA_T_COUNT],       // names for basic types
        globalstate_tmname<TString*> tmname[TM_N]);             // array with tag-method names
...
struct lua_State
{
    ...
    LUAU_SHUFFLE6(LUAU_SEMICOLON_SEP,
        StkId top,               //a0                        // first free slot in the stack
        StkId base,              //a1                         // base of current function
        luastate_global<global_State*> global, //a2
        CallInfo* ci, //a3                               // call info for current function
        StkId stack_last,      //a4                         // last free slot in the stack
        StkId stack);          //a5                          // stack base
